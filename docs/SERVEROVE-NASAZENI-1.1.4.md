# Lesson Hub Server 1.1.4 – produkční stabilizace

## Rozsah

Verze 1.1.4 zachovává provozní funkce 1.1.2 a opravuje GitHub QA spuštění. Serverová část nadále rozšiřuje server 1.0.0 o provozní monitoring, ruční a automatické snapshoty, kontrolovaný návrat ze zálohy a správní údržbu. Nemění model vlastnictví dat ani klientské schéma IndexedDB.
